...
def alin_yhteinen_nimittaja(osoittajat: list) -> int:
    ...
    while True:
        ...
        for tekijä in osoittajat:
            ...
            print(f"Luku {i} on jaollinen kaikilla määritellyillä tekijöillä.")
            return i
...
stressinlievitys = alin_yhteinen_nimittaja(jakajat)

for i in range(10000):
    for apina in apinat:
        apina.kierros()
    # print(f"Kierros {i} heitelty")
